...
\chapter{8\textsuperscript{th} Sunday in Ordinary Time (Year A)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Quaerite primum} \label{Quaerite primum (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 6:33} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--quaerite_primum--dominican--id_5115} \vspace{5pt} \emph{Seek first the kingdom of God, and his justice; and all these things will be given to you, alleluia.}
