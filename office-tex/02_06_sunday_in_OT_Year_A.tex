...
\chapter{6\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I \textsc{d}} \index[Antiphona ad Magnificat]{Si offers} \label{Si offers (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 5:23-24} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--si_offers--dominican--id_6761} \vspace{5pt} \emph{If you are offering your gift before the altar and recall that your brother has something against you, leave your gift before the altar, and go first to be reconciled with your brother; and then return and offer your gift, alleluia.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I \textsc{d}} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel} \grechangedim{maxbaroffsettextleft}{0.3 cm}{scalable} \gregorioscore{chants/magnificat1d} \input{chants/magnificat-translation}
