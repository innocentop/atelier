...
\chapter{24\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Serve nequam} \label{Serve nequam (Antiphona ad Magnificat)} \grecommentary[5pt]{Mt 18:32-33} \grechangestyle{initial}{\fontsize{1}{1}\selectfont} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--serve_nequam--dominican--id_5557} \vspace{5pt} \emph{``Wicked servant, I have released all your debts, as you entreated me. Is it not therefore fitting that you also have mercy on your fellow servant, as I have had mercy on you?’’ says the Lord.}   
