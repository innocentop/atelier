...
\chapter{20\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{IV \textsc{e}} \index[Antiphona ad Magnificat]{Putatis quia pacem} \label{Putatis quia pacem (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 12:51 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--putatis_quia--solesmes-op} \vspace{5pt} \emph{Do you think that I have come to bring peace upon the earth? Not peace, I say, but division.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{IV \textsc{e}} \index[Canticum Evangelicum]{Magnificat 8G} \label{Magnificat 8G (Canticum Evangelicum)} \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat4E} \input{chants/magnificat-translation}
