...
\subsubsection{Hymnus}  \greannotation{VI} \grecommentary[10pt]{\emph{Te Ioseph celebrent}} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.3cm}{scalable} \gresetlyriccentering{syllable}   \gregorioscore{chants/hy--te_ioseph_celebrent--english}

\grechangedim{maxbaroffsettextleft@nobar}{0cm}{scalable}

\newpage

\gabcsnippet{(f3) (hr f) †(;3) (hr i h) (;) <v>$\star$</v>(hr g e f::)}

\newpage

\gabcsnippet{(c4) (jr h) †(;3) (jr k j) <v>$\star$</v>(;) (jr h g::)}

\newpage

\gabcsnippet{(c4) (hr g) †(;3) (hr ixi g h) <v>$\star$</v>(;) (hr f g f::)}

\newpage

\raggedbottom

\gabcsnippet{(c3) (ir h) †(;3) (ir k i j) <v>$\star$</v>(;) (ir j h f::)}
