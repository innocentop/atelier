...
%%Combination
\chapter{9\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I \textsc{d}} \index[Antiphona ad Magnificat]{Dixit Iesus ad legisperitos} \label{Dixit Iesus ad legisperitos (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 14:3-4} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--dixit_iesus_ad_legisperitos--dominican--id_6338} \vspace{5pt} \emph{Jesus said to the scholars of the Law and the Pharisees: ``Is it permitted to cure on the Sabbath?” But they did not respond to him. So he took the man suffering from dropsy, healed him, and dismissed him.} 

  \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I \textsc{d}}  \grecommentary[3pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel} \gregorioscore{chants/magnificat1d} \input{chants/magnificat-translation}
 ...
 \subsubsection{Preces}   \index[Preces]{Week I, Sunday, Second Vespers} \label{Week I, Sunday, Second Vespers (Preces)}    \input{intercessions/intercessions-ot-sunday-week-1-2nd-vespers} \newpage
  ...
  \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{25th Sunday in OT} \label{25th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.09}
