...
%%Combination
\chapter{21\textsuperscript{st} Sunday in Ordinary Time (Year A)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Quodcumque ligaveris} \label{Quodcumque ligaveris (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 16:19; Io 21:15} \grechangestyle{initial}{\fontsize{1}{1}\selectfont} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--quodcumque--dominican--id_5245} \vspace{5pt} \emph{``Whatever you shall bind on earth will be bound also in heaven, and whatever you shall loose on earth will be loosed also in heaven,” says the Lord to Simon Peter.}   
 
   \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}}  \grecommentary[3pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel} \gregorioscore{chants/magnificat8G} \input{chants/magnificat-translation}
 ...
 \subsubsection{Preces}   \index[Preces]{Week I, Sunday, Second Vespers} \label{Week I, Sunday, Second Vespers (Preces)}    \input{intercessions/intercessions-ot-sunday-week-1-2nd-vespers}
  ...
  \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{25th Sunday in OT} \label{25th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.21}
