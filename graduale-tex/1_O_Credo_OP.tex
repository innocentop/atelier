...
\chapter[Graduale O.P.]{Graduale O.P.}



%%Combination
 \subsection{Credo}  \greannotation{I} \index[Credo]{Credo} \label{Credo (Credo)} \grecommentary[0pt]{} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/ky--credo--dominican--id_7294}  \vspace{5pt} \par{} \newpage
