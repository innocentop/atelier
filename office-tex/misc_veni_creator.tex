...
%%Combination
 \subsubsection{Hymnus}  \greannotation{VIII} \index[Hymnus]{Æterne Rex altissime} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \grechangedim{spaceabovelines}{0.5 cm}{scalable} \gregorioscore{chants/hy--veni_creator_spiritus--latin.gabc}    
