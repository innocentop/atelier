...
%%Combination
\chapter{9\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Nam et ego} \label{Nam et ego (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 8:9 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--nam_et_ego--solesmes-op} \vspace{5pt} \emph{For I too am a man placed under power, having soldiers under me; and I say to one, ``Go," and he goes, and to my servant, ``Do this," and he does it.}
