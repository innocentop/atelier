...
%%Combination
\chapter{21\textsuperscript{st} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Multi venient} \label{Multi venient (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 8:11 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--multi_venient--solesmes-op} \vspace{5pt} \emph{Many shall come from the east and the west and will recline with Abraham and Isaac and Jacob in the kingdom of heaven, alleluia.}
