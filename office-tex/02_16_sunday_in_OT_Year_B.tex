...
\chapter{16\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Videns Iesus multam turbam} \label{Videns Iesus multam turbam (Antiphona ad Magnificat)} \grecommentary[0pt]{Mc 6:34 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--videns_iesus_multam_turbam--solesmes-op} \vspace{5pt} \emph{When Jesus saw the large crowd, he had mercy on them, because they were like sheep without a shepherd.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I g} \index[Canticum Evangelicum]{} \label{ (Canticum Evangelicum)} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1g}  \input{chants/magnificat-translation}
 ...
 \subsubsection{Oratio conclusiva}     \input{prayers/or-ordinary-time.16}
