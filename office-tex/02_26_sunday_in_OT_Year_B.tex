...
\chapter{26\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Bonum est tibi} \label{Bonum est tibi (Antiphona ad Magnificat)} \grecommentary[0pt]{Mc 9:42 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--bonum_est_tibi--solesmes-op} \vspace{5pt} \emph{It is better for you to enter into life maimed than to have two hands and go to Gehenna.}
