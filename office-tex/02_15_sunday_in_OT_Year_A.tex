...
\chapter{15\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\pagebreak
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VI} \index[Antiphona ad Magnificat]{Vobis datum est} \label{Vobis datum est (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 8:10} \grechangestyle{initial}{\fontsize{1}{1}\selectfont} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--vobis_datum_est_nosse_mysterium--dominican--id_6126} \vspace{5pt} \emph{``To you it is given to know the mystery of the Kingdom of God, but to others [I speak] in parables,” Jesus said to his disciples.}   
...
\pagebreak
 ...
 \subsubsection{Oratio conclusiva} \input{prayers/or-ordinary-time.15}
