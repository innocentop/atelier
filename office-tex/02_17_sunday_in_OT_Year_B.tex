...
%%Combination
\chapter{17\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Ut autem saturati} \label{Ut autem saturati (Antiphona ad Magnificat)} \grecommentary[0pt]{Io 6:12-13 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--ut_autem_saturati--solesmes-op} \vspace{5pt} \emph{In order that they might be satisfied, Jesus said to his disciples: ``Gather the fragments that are left over, lest they perish.” Thus they gathered them, and they filled twelve baskets with the fragments, which had come from the five barley loaves, which were left over from that which they had eaten.}
 ...
 \subsubsection{Preces}   \index[Preces]{Week I, Sunday, Second Vespers} \label{Week I, Sunday, Second Vespers (Preces)}    \input{intercessions/intercessions-ot-sunday-week-1-2nd-vespers}
  ...
  \subsubsection{Oratio conclusiva}   \input{prayers/or-ordinary-time.17}
