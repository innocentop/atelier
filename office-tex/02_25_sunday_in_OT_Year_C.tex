...
%%Combination
\chapter{25\textsuperscript{th} Sunday in Ordinary Time (Year C)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{IV \textsc{e}} \index[Antiphona ad Magnificat]{Quid faciam} \label{Quid faciam (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 16:3-4} \gresetinitiallines{1} \gresetlyriccentering{vowel} \gregorioscore{chants/an--quid_faciam--dominican--id_6044} \vspace{5pt} \emph{What shall I do, now that my master is taking the position of steward away from me? I am not strong enough to dig and I am ashamed to beg. I know what I shall do so that, when I am removed from the stewardship, they may welcome me into their homes.}
