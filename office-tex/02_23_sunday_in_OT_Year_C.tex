...
\chapter{23\textsuperscript{rd} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VII d} \index[Antiphona ad Magnificat]{Christus nobis dicit} \label{Christus nobis dicit (Antiphona ad Magnificat)} \grecommentary[5pt]{Lc 14:33 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--christus_nobis_dicit--solesmes-op} \vspace{5pt} \emph{Christ says to us in the gospel: He who does not renounce all that he possesses, cannot be my disciple.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VII d} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat7d} \input{chants/magnificat-translation}
