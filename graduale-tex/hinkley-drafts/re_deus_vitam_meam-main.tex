...
\begin{center}\begin{huge}\textsc{Deus, vitam meam}\end{huge}\end{center}
\begin{center}1950 Graduale (Suarez), page(s) 111\end{center}
...
\gresetsecondannotation{\small \textsc{\textbf{VIII.}}}
...
\includescore{re_deus_vitam_meam.tex}
