...
\newcommand{\lectio}[3]{%
  ...
  \section{St. Stephen}
   \subsubsection{Hymn}  \greannotation{III} \index[Hymn]{With honor let us celebrate} \label{With honor let us celebrate (Hymn)} \grecommentary[10pt]{\small{Melody 3 (D\flat) -- 8.8.8.8 (LM)}} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}   \gregorioscore{chants/12.26.Stephen-OOR-With_honor_let_us_celebrate} \vspace{10pt} Text: \textit{Festum celebre martyris}, ca. 13th c. English translation © 2023 ICEL.
