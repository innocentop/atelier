...
%%Combination
\chapter{17\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Vos cum sitis mali} \label{Vos cum sitis mali (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 11:13 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--vos_cum_sitis--solesmes-op} \vspace{5pt} \emph{If you who are evil know how to give good things to your children, how much more will your heavenly Father give the good Spirit to those who themselves pray for it.}
