...
\chapter[4\textsuperscript{th} Sunday in Ordinary Time]{St. James Gradual}
...
%%Combination
\subsubsection{Officium}  \greannotation{II} \index[Officium]{Lætetur cor} \label{Lætetur cor (Officium)} \grecommentary[5pt]{\emph{Lætetur cor:} Ps 104:3, 4; \Vbar. 1} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/in--laetetur_cor--dominican--id_6129--en}   \newpage
\subsubsection{Offertorium}  \greannotation{VIII} \index[Offertorium]{Bonum est confiteri} \label{Bonum est confiteri (Offertorium)} \grecommentary[10pt]{\emph{Bonum est confiteri:} Ps 91:2} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/of--bonum_est_confiteri--dominican--id_7242--en}   \newpage
\subsubsection{Communio} Dom. anno A: \greannotation{I} \index[Communio]{Beati mundo corde} \label{Beati mundo corde (Communio)} \grecommentary[3pt]{\emph{Beati mundo corde:} Mt 5:8, 9, 10 [GR]} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/co--beati_mundo_corde--vatican--en}   \newpage
\subsubsection{Communio} Dom. annis B et C et in feriis: \greannotation{I} \index[Communio]{Illumina faciem tuam} \label{Illumina faciem tuam (Communio)} \grecommentary[3pt]{\emph{Illumina faciem tuam:} Ps 30:17, 18} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/co--illumina_faciem--dominican--id_4792--en}   \newpage
