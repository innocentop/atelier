...
\section{First Vespers}
 ...
 \subsubsection{Responsorium prolixa}  \greannotation{VIII} \index[Responsorium prolixa]{Hi qui amicti sunt} \label{Hi qui amicti sunt (Responsorium prolixa)} \grecommentary[5pt]{Apc 7:13b, 14b, \Vbar. 15a} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5 cm}{scalable} \gregorioscore{chants/rp--hi_qui_amicti_sunt--dominican} \vspace{5pt} \textit{Who are these, clothed in white robes, and whence have they come? These are they who have washed their robes and made them white * in the blood of the Lamb. \Vbar. Therefore are they before the throne of God, and serve him day and night within his temple. * In the blood of the Lamb. Glory to the Father and to the Son and to the Holy Spirit. * In the blood of the Lamb. (Proprium OP 663)}   \newpage
