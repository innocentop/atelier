...
%%Combination
 ...
 \subsubsection{Responsorium}  \greannotation{II} \index[Responsorium]{Libera me Domine} \label{Libera me Domine (Responsorium)} \grecommentary[0pt]{Ecclesia} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.75cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/re--libera_me_domine--dominican}  \vspace{5pt} \par{} \newpage
