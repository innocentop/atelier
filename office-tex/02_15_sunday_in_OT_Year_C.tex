...
\chapter{15\textsuperscript{th} Sunday in Ordinary Time (Year C)}
...
\pagebreak
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VII a} \index[Antiphona ad Magnificat]{Quis tibi videtur} \label{Quis tibi videtur (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 10:36-37} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--quis_tibi_videtur--dominican--id_5562} \vspace{5pt} \emph{``Who do you think was the neighbor to the one who had fallen into the hands of thieves?” And he said to him: ``The one who was merciful to him.” ``Go, and do likewise, alleluia.”}
