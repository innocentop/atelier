...
\chapter{19\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I \textsc{d}} \index[Antiphona ad Magnificat]{Sint lumbi vestri} \label{Sint lumbi vestri (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 12:35, 36} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--sint_lumbi--dominican--id_6034} \vspace{5pt} \emph{Keep your loins girded and your lamps burning in your hands; and be like men waiting for their Lord when he is returning from a wedding.}
