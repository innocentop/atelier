...
\chapter{22\textsuperscript{nd} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Non quod intrat} \label{Non quod intrat (Antiphona ad Magnificat)} \grecommentary[3pt]{Mt 15:10-11 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--non_quod_intrat--solesmes-op} \vspace{5pt} \emph{It is not that which enters the mouth that defiles a man, but that which proceeds from the mouth that defiles a man.}
