...
\chapter{2\textsuperscript{nd} Sunday in Ordinary Time (Year A)}
...
%%This is the version for Week II and IV
 ...
 \subsubsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Magnus Dominus noster} \label{Magnus Dominus noster (Responsorium brevis)} \grecommentary[0pt]{Ps 146:5 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/rb--magnus_dominus_noster--solesmes}
  ...
  \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Hoc est testimonium} \label{Hoc est testimonium (Antiphona ad Magnificat)} \grecommentary[0pt]{Io 1:32, 15 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--hoc_est_testimonium--solesmes} \vspace{5pt} \emph{This is the testimony that John bore: ``The one who comes after me was before me."}
