...
%%Combination
\chapter{13\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Hymnus}  \greannotation{VIII} \index[Hymnus]{Lucis creator} \label{Lucis creator (Hymnus)} \grecommentary[10pt]{\emph{Lucis creator optime}} \gresetinitiallines{1} \gresetlyriccentering{syllable} \grechangedim{spaceabovelines}{0.5cm}{scalable}  \gregorioscore{chants/hy--lucis-creator-english}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{III a} \index[Antiphona ad Magnificat]{Loquente Iesu ad turbas} \label{Loquente Iesu ad turbas (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 9:18} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--loquente--dominican--id_6346} \vspace{5pt} \emph{While Jesus was speaking to the crowds, behold, a leader approached, adoring him, saying: ``O Lord, my daughter has just died; but come, place your hand on her, and she will live, alleluia.”}   

   \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{III a}  \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel} \gregorioscore{chants/magnificat3a} \input{chants/magnificat-translation}
 ...
 \newpage
  ...
  \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{13th Sunday in OT} \label{25th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.13}
