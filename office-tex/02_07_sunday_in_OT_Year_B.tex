...
\chapter{7\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{IV \textsc{e}} \index[Antiphona ad Magnificat]{Tulit ergo} \label{Tulit ergo (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 5:25; 18:43} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--tulit_ergo--dominican--id_6113} \vspace{5pt} \emph{The paralytic therefore took up his bed, on which he had been lying, praising God. And the whole people, since they had seen, gave praise to God, alleluia.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{IV \textsc{e}} \index[Canticum Evangelicum]{Magnificat 8G}  \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat4E-f3} \input{chants/magnificat-translation}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva} \input{prayers/or-ordinary-time.07}
