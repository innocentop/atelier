...
\section{Missa pro Defunctis}
 ...
 \subsubsection{Offertorium}  \greannotation{II} \index[Offertorium]{Domine Iesu Christe} \label{Domine Iesu Christe (Offertorium)} \grecommentary[0pt]{Cf. Ps 21:22; Dn 3:88; 2 Pt 2:4} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/of--domine_iesu_christe--dominican--id_6575}  \vspace{5pt} \par{O Lord Jesus Christ, King of Glory, deliver the souls of all the faithful departed from the grip of hell and from the deep pit; deliver them from the mouth of the lion, that hell may not swallow them up, and they may not fall into darkness; but may the standard-bearer Saint Michael introduce them to the holy light, which you promised of old to Abraham and his descendants. \Vbar. We offer sacrifices and prayers to you, O Lord; receive them for the souls that we are remembering today; O Lord, make them pass from death to that life, which you promised of old to Abraham and his descendants.} \newpage
