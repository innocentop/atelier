...
\usepackage[inner=0.6in, outer=0.4in, top=0.5in, bottom=0.5in, papersize={5.5in,8.5in}, head=12pt, headheight=30pt, headsep=5pt]{geometry}
...
%%Titlesec modified for Triduum booklet (3.22.20)
...
\newcommand{\lectio}[3]{%
  ...
  \begin{titlepage}
     ...
     % \rule{\textwidth}{1.6pt}\vspace*{-\baselineskip}\vspace*{2pt}
      ...
      {\fontsize{45pt}{45}\selectfont \textsc{Triduum\\ante Pascha}
  ...
  \centering
      ...
      \vfill
      {\fontsize{13pt}{20pt}\selectfont \textsc{München} \par \textsc{Dominikanerkonvent St. Kajetan} \par \scshape{2020} \par }}
    \end{titlepage}
  ...
  %%Combination
  \newgeometry{inner=1.5in, outer=1.5in, top=2in, bottom=0.5in}
