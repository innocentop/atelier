...
\chapter{4\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Mirabantur omnes} \label{Mirabantur omnes (Antiphona ad Magnificat)} \grecommentary[5pt]{Mc 1:27 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--mirabantur_omnes--solesmes} \vspace{5pt} \emph{All who heard him marvelled, saying: ``Who is this? He commands unclean spirits, and they obey him."}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}     \input{prayers/or-ordinary-time.04}
