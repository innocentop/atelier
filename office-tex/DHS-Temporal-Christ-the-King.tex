...
\chapter{Christ the King}
 \subsubsection{Responsorium prolixum}  \greannotation{VIII} \index[Responsorium prolixum]{Tua est potentia} \label{Tua est potentia (Responsorium prolixum)} \grecommentary[5pt]{Cf. I Par 29:11; Sir 50:25; \Vbar. 2 Mcc 1:24} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5 cm}{scalable} \gregorioscore{chants/rp--tua_est_potentia--dominican} \vspace{5pt} \textit{Yours is power, yours is the Kingdom, O Lord; you are over all nations. * Give peace, Lord, in our days. \Vbar. O God, creator of all things, you are dreadful and strong, just and merciful. * Give peace, Lord, in our days. \Vbar. Glory to the Father and to the Son and to the Holy Spirit. * In our days.} \par (Proprium OP, p. 715)   \newpage
