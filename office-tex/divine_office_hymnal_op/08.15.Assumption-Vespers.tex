...
%%Titles (rev. 2024) -- TOCLESS --- lets you have sections that don't appear in the table of contents
...
\newcommand{\lectio}[3]{%
  ...
  \subsection{Vespers}
   \subsubsection{Hymn}  \greannotation{I} \index[Hymn]{New star of heaven} \label{New star of heaven (Hymn)} \grecommentary[10pt]{\small{Melody 50 (A\flat) -- 11.11.11.5}} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}   \gregorioscore{chants/08.15.Assumption-Vespers-New_star_of_heaven} \vspace{10pt} Text: \textit{Gaudium mundi, nova stella cæli}, St. Peter Damian, O.S.B. Camald., d. 1072. English translation © 2023 ICEL.  
