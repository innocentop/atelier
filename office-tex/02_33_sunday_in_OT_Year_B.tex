...
%%Combination
\chapter{33\textsuperscript{rd} Sunday in Ordinary Time (Year B)}
...
\section{Second Vespers}
 ...
 \subsubsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Benedictus es, Domine} \label{Benedictus es, Domine (Responsorium brevis)} \grecommentary[0pt]{Dan 3:56 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/rb--benedictus_es_domine--solesmes}
   ...
   \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Amen dico vobis quia non} \label{Amen dico vobis quia non (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 21:32-33} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--amen_dico_quia_non--dominican--id_4893} \vspace{5pt} \emph{Amen, I say to you, this generation will not pass away until all this comes to pass. Heaven and earth will pass away, but my words will not pass away, says the Lord.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I g}  \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1g} \input{chants/magnificat-translation}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{33rd Sunday in OT} \label{33rd Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.33}
