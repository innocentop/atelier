...
%%Combination
 ...
 \subsection{Offertorium} Quando legitur Evangelium de filio prodigo (Anno C): \greannotation{IV} \index[Offertorium]{Illumina oculos meos} \label{Illumina oculos meos (Offertorium)} \grecommentary[0pt]{Ps 12:4, 5} \gresetinitiallines{1}  \gregorioscore{graduale-chants/of--illumina--dominican--id_5998}  \vspace{5pt} \par{Enlighten my eyes, that I never sleep in death, lest at any time my enemy say, "I have prevailed against him."} \newpage
 \subsection{Communio}  \greannotation{IV} \index[Communio]{Ierusalem quæ ædificatur} \label{Ierusalem quæ ædificatur (Communio)} \grecommentary[0pt]{Ps 121:3, 4} \gresetinitiallines{1}  \gregorioscore{graduale-chants/co--ierusalem_quae--dominican--id_5394}  \vspace{5pt} \par{Jerusalem, which is built as a city, which is compact together; for there did the tribes go up, the tribes of the Lord, to praise Your name, O Lord.} \newpage

 \subsection{Communio} Quando legitur Evangelium de cæco nato (Anno A): \greannotation{VI} \index[Communio]{Lutum fecit} \label{Lutum fecit (Communio)} \grecommentary[0pt]{Io 9:6, 11, 38} \gresetinitiallines{1}  \gregorioscore{graduale-chants/co--lutum_fecit--dominican--id_6341}  \vspace{5pt} \par{The Lord made clay of spittle, and anointed my eyes, and I went, and washed, and I saw; and I believed in God.} \newpage

 \subsection{Communio} Quando legitur Evangelium de filio prodigo (Anno C): \greannotation{VIII} \index[Communio]{Oportet te} \label{Oportet te (Communio)} \grecommentary[0pt]{Lc 15:32} \gresetinitiallines{1}  \gregorioscore{graduale-chants/co--oportet_te_fili--dominican--id_6842}  \vspace{5pt} \par{You ought to rejoice, my son, because Your brother was dead, and has come to life; he was lost, and is found.} \newpage
