...
\usepackage[inner=0.6in, outer=0.6in, top=0.5in, bottom=0.5in, papersize={7in,10in}, head=12pt, headheight=30pt, headsep=5pt]{geometry}
...
\subsubsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Iustus ut palma ...alleluia} \label{Iustus ut palma ...alleluia (Responsorium brevis)} \grecommentary[0pt]{Ps 91:12} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/rb--iustus_ut_palma_alleluia--dominican--id_5788--repeats}
\subsubsection{Responsorium prolixa}  \greannotation{VII} \index[Responsorium prolixa]{Iustus ut palma} \label{Iustus ut palma (Responsorium prolixa)} \grecommentary[0pt]{Ps 91:12-13; \Vbar. Ps 111:3} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont}
\grechangedim{maxbaroffsettextleft}{0pt}{scalable}
 \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/rp--iustus_ut_palma--dominican}
%%Combination
