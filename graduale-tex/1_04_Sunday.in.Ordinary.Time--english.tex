...
%%Combination
\subsubsection{Introit}  \greannotation{II} \index[Introit]{Lætetur cor} \label{Lætetur cor (Introit)} \grecommentary[5pt]{\emph{Lætetur cor:} Ps 104:3, 4; \Vbar. 1} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/in--laetetur_cor--dominican--id_6129--en}   \newpage
\subsubsection{Offertory}  \greannotation{VIII} \index[Offertory]{Bonum est confiteri} \label{Bonum est confiteri (Offertory)} \grecommentary[10pt]{\emph{Bonum est confiteri:} Ps 91:2} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/of--bonum_est_confiteri--dominican--id_7242--en}   \newpage
\subsubsection{Communion} Dom. anno A: \greannotation{I} \index[Communion]{Beati mundo corde} \label{Beati mundo corde (Communion)} \grecommentary[3pt]{\emph{Beati mundo corde:} Mt 5:8, 9, 10 [GR]} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/co--beati_mundo_corde--vatican--en}   \newpage
\subsubsection{Communion} Dom. annis B et C et in feriis: \greannotation{I} \index[Communion]{Illumina faciem tuam} \label{Illumina faciem tuam (Communion)} \grecommentary[3pt]{\emph{Illumina faciem tuam:} Ps 30:17, 18} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/co--illumina_faciem--dominican--id_4792--en}   \newpage
