...
\section{Common of the Dedication of a Church}
 ...
 \subsubsection{Offertorium}  \greannotation{VI} \index[Offertorium]{Domine Deus in simplicitate} \label{Domine Deus in simplicitate (Offertorium)} \grecommentary[5pt]{1 Chr 29:17, 18} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/of--domine_deus_in_simplicitate--dominican--id_5927}  \vspace{5pt} \par{Lord God, in the simplicity of my heart I have joyfully offered all things; and with great joy I have seen your people, who are present here. O God of Israel, preserve this good intention. \textit{T.P.} Alleluia.} \newpage
