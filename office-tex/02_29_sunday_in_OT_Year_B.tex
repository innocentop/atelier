...
%%Combination
\chapter{29\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Quicumque voluerit} \label{Quicumque voluerit (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 20:26-27 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--quicumque_voluerit--solesmes-op} \vspace{5pt} \emph{Whoever wishes to be greatest among you, must be your minister; and he who wishes to be first among you, must be your servant.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}} \index[Canticum Evangelicum]{Magnificat Ig} \label{Magnificat 8c (Canticum Evangelicum)} \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat8G} \input{chants/magnificat-translation}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{29th Sunday in OT} \label{29th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.29}
