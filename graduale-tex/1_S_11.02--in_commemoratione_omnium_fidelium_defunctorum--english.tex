...
\subsubsection{Offertorium}  \greannotation{II} \index[Offertorium]{Domine Iesu Christe} \label{Domine Iesu Christe (Offertorium)} \grecommentary[0pt]{\emph{Domine Iesu Christe}} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/of--domine_iesu_christe--dominican--id_6575--en}
