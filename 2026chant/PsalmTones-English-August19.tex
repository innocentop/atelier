...
\subsubsection{Mode III}
\gabcsnippet{(c4) (jr h) †(;3) (jr k i j) *(;) (jr h g h) (::) Or:(jr h) †(;3) (jr i h j) *(;) (jr i h) (::)}

\subsubsection{Mode III (Option 2)}
\gabcsnippet{(c4) (jr h) †(;3) (jr k i j) *(;) (jr i h) (::)}

\subsubsection{Mode III (Option 3)}
\gabcsnippet{(c4) (jr h) †(;3) (jr i h j) *(;) (jr h g h)  (::)}

\subsubsection{Mode III (Option 4)}
\gabcsnippet{(c4) (jr h) †(;3) (jr i h j) *(;) (jr h i h)  (::)}

\subsubsection{Mode IV}
\gabcsnippet{(c4) (hr g) †(;3) (hr g i h) *(;) (hr g e) (::) Or: (hr g) †(;3) (hr g i h) *(;) (hr i g  e) (::)}
\subsubsection{Mode V}
\gabcsnippet{(c3) (hr f) †(;3) (hr i h) *(;) (hr g h f) (::) Or: (hr f) †(;3) (hr i h) *(;) (hr f e f) (::)}

\subsubsection{Mode V (Option 2)}
\gabcsnippet{(c3) (hr f) †(;3) (hr i h) *(;) (hr i g f) (::)}

\subsubsection{Mode V (Option 3)}
\gabcsnippet{(c3) (hr f) †(;3) (hr f h) *(;) (hr i g f) (::)}

\subsubsection{Mode VI}
\gabcsnippet{(c4) (hr g) †(;3) (hr g h) *(;) (hr f g f) (::) Or: (hr g) †(;3) (hr f g h) *(;) (hr g h f) (::)}
\subsubsection{Mode VII}
\gabcsnippet{(c3) (ir h) †(;3) (ir k i j) *(;) (ir j h i) (::) Or: (ir h) †(;3) (ir j k j) *(;) (ir h i) (::)}
