...
%%Combination
\chapter{32\textsuperscript{nd} Sunday in Ordinary Time (Year C)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Ego sum Deus} \label{Ego sum Deus (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 22:32} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--ego_sum_deus_abraham--solesmes} \vspace{5pt} \emph{I am the God of Abraham and the God of Isaac and the God of Jacob. I am not the God of the dead but of the living, says the Lord.}
