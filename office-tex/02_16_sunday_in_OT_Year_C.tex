...
\chapter{16\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{IV \textsc{a}} \index[Antiphona ad Magnificat]{Optimam partem} \label{Optimam partem (Antiphona ad Magnificat)} \grecommentary[4pt]{Lc 10:42 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--optimam_partem--solesmes-op} \vspace{5pt} \emph{Mary has chosen for herself the better part, which shall not be taken away from her in eternity.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{IV \textsc{a}} \index[Canticum Evangelicum]{} \label{ (Canticum Evangelicum)} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat4A}  \input{chants/magnificat-translation}
