...
%%Combination
\section{Missa pro Defunctis}

\subsubsection{Officium}  \greannotation{VI} \index[Officium]{Requiem} \label{Requiem (Officium)} \grecommentary[5pt]{IV Esdr 2:34, 35; \Vbar. Ps 64:2–3} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/in--requiem--dominican--id_6527}  \vspace{5pt} \par{Eternal rest grant unto them, O Lord, and let perpetual light shine upon them. \Vbar. A hymn, O God, becomes you in Zion, and a vow shall be paid to you in Jerusalem; hear my prayer; all flesh shall come to you.}
\subsubsection{Communio}  \greannotation{VIII} \index[Communio]{Lux æterna} \label{Lux æterna (Communio)} \grecommentary[5pt]{IV Esdr 2:35} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/co--lux_aeterna--dominican--id_6519}  \vspace{5pt} \par{Let eternal light shine upon them, O Lord, with your saints forever, for you are merciful. } \newpage
