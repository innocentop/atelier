...
\chapter{15\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\pagebreak
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Egressi duodecim} \label{Egressi duodecim (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 9:6} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--egressi_duodecim--dominican--id_5609--no_alleluia} \vspace{5pt} \emph{The twelve apostles went out, going throughout the towns, evangelizing and curing everywhere.}   
