...
%%Combination
\chapter{29\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Reddite ergo} \label{Reddite ergo (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 22:21} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--reddite_ergo--dominican} \vspace{5pt} \emph{Render that which is Caesar's to Caestar, and that which is God's to God, alleluia.}
