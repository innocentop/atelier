...
%%Combination
\chapter{5\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Aliis civitatibus} \label{Aliis civitatibus (Antiphona ad Magnificat)} \grecommentary[5pt]{Lc 4:43 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--aliis_civitatibus--solesmes} \vspace{5pt} \emph{It is necessary for me to proclaim the good news of the Kingdom of God to other cities, for I was sent for this purpose. }
 ...
 \subsubsection{Preces}   \index[Preces]{Week I, Sunday, Second Vespers} \label{Week I, Sunday, Second Vespers (Preces)}    \input{intercessions/intercessions-ot-sunday-week-1-2nd-vespers} \newpage 
  ...
  \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{25th Sunday in OT} \label{25th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.05}
