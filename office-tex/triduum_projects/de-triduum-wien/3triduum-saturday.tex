...
%%Page Size (rev. 2022)
\usepackage[inner=0.6in, outer=0.6in, top=0.6in, bottom=0.6in, papersize={6in,9in}, head=12pt, headheight=30pt, headsep=5pt]{geometry}
...
\grechangestyle{translation}{\fontsize{12}{12}\it\selectfont}
\grechangestyle{annotation}{\fontsize{12}{12}\selectfont}
