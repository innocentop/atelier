...
\chapter{2\textsuperscript{nd} Sunday in Ordinary Time (Year C)}
...
%%This is the version for Week II and IV
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Deficiente vino} \label{Deficiente vino (Antiphona ad Magnificat)} \grecommentary[0pt]{Cf. Io 2:3, 7} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--deficiente_vino--dominican--id_5599} \vspace{5pt} \emph{After the wine ran out, Jesus commanded that jugs should be filled with water, which was turned into wine, alleluia.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I g} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1g}  \newpage \input{chants/magnificat-translation}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}       \input{prayers/or-ordinary-time.02}
