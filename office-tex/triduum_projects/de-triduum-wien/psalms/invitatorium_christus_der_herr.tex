...
\nopagebreak
\greannotation{II}
\gabcsnippet{(f3) Chri(f)stus,(c) der(e) Herr,(f_) wur(f)de(f) für(e) uns(f) ver(g)sucht(e) (,) und(f) hat(f) für(f) uns(h) ge(f)lit(hi)ten;(i) (;) kommt,(h_) wir(h) be(h)ten(g) ihn(e) an!(f) (::)
}

\vspace{5pt}

\emph{Der folgende Psalm zum Invitatorium wird vom Vorsänger nach der im Anhang (S. ???) angegebenen Melodie gesungen. Nach den einzelnen Abschnitten des Psalms wird jewils die Antiphon von Allen wiederholt.}
...
und hatten doch mein Tun gesehen.» (Antiphon)
