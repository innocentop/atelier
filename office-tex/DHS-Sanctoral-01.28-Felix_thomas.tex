...
\chapter{Reception of the Relics\\of St. Thomas Aquinas}
 \subsubsection{Antiphona}  \greannotation{I} \index[Antiphona]{Felix Thomas} \label{Felix Thomas (Antiphona)} \grecommentary[5pt]{} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \grechangedim{maxbaroffsettextleft}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5 cm}{scalable} \gregorioscore{chants/an--felix_thomas} \vspace{5pt} \textit{Blessed Thomas, Doctor of the Church, light of the world, glory of Italy, virgin shining with the bloom of chastity, rejoices in a twofold crown of glory.}   \newpage
