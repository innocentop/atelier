...
\begin{center}\begin{huge}\textsc{Vir erat}\end{huge}\end{center}
\begin{center}1950 Graduale (Suarez), page(s) 346\end{center}
...
\gresetsecondannotation{\small \textsc{\textbf{II.}}}
