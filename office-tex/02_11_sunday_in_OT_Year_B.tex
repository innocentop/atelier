...
\chapter{11\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VII d} \index[Antiphona ad Magnificat]{Simile est regnum} \label{Simile est regnum (Antiphona ad Magnificat)} \grecommentary[4pt]{Mt 13:31, 32} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--simile_est_regnum_caelorum_grano--dominican--id_5698} \vspace{5pt} \emph{The Kingdom of Heaven is like a mustard seed, which is the smallest of all seeds; but when it grows, it is is greater than all the other plants.}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva} \input{prayers/or-ordinary-time.11}
