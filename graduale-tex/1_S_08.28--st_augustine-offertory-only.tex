...
\subsubsection{Officium}  \greannotation{VI} \index[Officium]{In medio Ecclesiæ} \label{In medio Ecclesiæ (Officium)} \grecommentary[3pt]{Sir 15:5; \Vbar. 6} \gresetinitiallines{2} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel} \grechangestyle{initial}{\fontsize{120}{120}\selectfont} \gregorioscore{graduale-chants/in--in_medio--dominican--no_alleluia--two-line-initial} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \vspace{5pt} \par{In the midst of the Church he opened his mouth, and the Lord filled him with the spirit of wisdom and understanding; he clothed him with a robe of glory. \Vbar. Joy and gladness he has lavished upon him.} \newpage
\end{document}
