...
\chapter{18\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I \textsc{d}} \index[Antiphona ad Magnificat]{Dixit Dominus Iesus Ego} \label{Dixit Dominus Iesus Ego (Antiphona ad Magnificat)} \grecommentary[0pt]{Io 6:35 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--dixit_dominus_iesus_ego--solesmes-op} \vspace{5pt} \emph{The Lord Jesus said: ``I am the bread of life; he who comes to me shall not hunger, and he who believes in me shall never thirst, alleluia."}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I \textsc{d}} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1D} \input{chants/magnificat-translation}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}       \input{prayers/or-ordinary-time.18}
