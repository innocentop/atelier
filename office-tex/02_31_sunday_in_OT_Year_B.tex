...
%%Combination
\chapter{31\textsuperscript{st} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VII d} \index[Antiphona ad Magnificat]{Diligamus nos invicem} \label{Diligamus nos invicem (Antiphona ad Magnificat)} \grecommentary[2pt]{1 Io 4:7 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--diligamus_nos--solesmes-op} \vspace{5pt} \emph{Let us love one another, for love is from God; and he who loves his brother, is born of God and sees God.}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{31st Sunday in OT} \label{31st Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.31}
