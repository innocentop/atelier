...
\chapter{3\textsuperscript{rd} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Benedictus es, Domine} \label{Benedictus es, Domine (Responsorium brevis)} \grecommentary[0pt]{Dan 3:56 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/rb--benedictus_es_domine--solesmes}   \newpage
  ...
  \subsubsection{Antiphona ad Magnificat}  \greannotation{III a2} \index[Antiphona ad Magnificat]{Cum plicuisset librum} \label{Cum plicuisset librum (Antiphona ad Magnificat)} \grecommentary[10pt]{Lc 4:20, 21 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--cum_plicuisset_librum--solesmes} \vspace{10pt} \emph{When he rolled up the scroll, Jesus began to speak to them: ``Today this scripture is fulfilled in your hearing," alleluia.}
 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{III a2} \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat3a2} \input{chants/magnificat-translation}
