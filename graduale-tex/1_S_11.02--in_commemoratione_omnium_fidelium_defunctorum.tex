...
\subsection{Die 2 novembris}
\section{In Commemoratione Omnium Fidelium Defunctorum}
...
%%Combination
  \subsection{Tractus}  \greannotation{VIII}  \gresetinitiallines{1}  \gregorioscore{graduale-chants/tr--absolve--dominican--id_6367}

\vspace{5pt} \par{Absolve, O Lord, the souls of all the faithful departed from every bond of sin. \Vbar. And by the help of Your grace may they be enabled to escape the judgment of punishment, and enjoy the happiness of eternal light.}
