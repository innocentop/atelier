...
\color{BrickRed}
 \thispagestyle{plain}
    ...
    \centering
    \vspace*{\baselineskip}
    {\fontsize{20pt}{20pt}\selectfont \textsc{The Offices of} \\ \vspace{5pt} \fontsize{30pt}{30pt}\selectfont \textsc{Good Friday} \\ \vspace{10pt} \fontsize{20pt}{20pt}\selectfont \\ \textsc{and} \\ \vspace{10pt} \fontsize{30pt}{30pt}\selectfont \textsc{Holy Saturday} \\ \vspace{10pt} \color{Black} \large \textsc{with elements proper to the}\\\vspace{10pt} \fontsize{20pt}{20pt}\selectfont \color{BrickRed} \textsc{Order of Friars Preachers}
...
\vspace{10pt} \thispagestyle{plain} \color{white}Triduum O.P. 2025
