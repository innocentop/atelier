...
%%Combination
\chapter{29\textsuperscript{th} Sunday in Ordinary Time (Year C)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII c} \index[Antiphona ad Magnificat]{Dum venerit} \label{Dum venerit (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 18:8} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--dum_venerit} \vspace{5pt} \emph{When the Son of Man comes, do you think he will find faith upon the earth?}
