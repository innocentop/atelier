...
%%Combination
\chapter{32\textsuperscript{nd} Sunday in Ordinary Time (Year A)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Dum autem irent} \label{Dum autem irent (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 25:10 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--dum_autem_irent--solesmes-op} \vspace{5pt} \emph{But while they went out to buy, behold, the bridegroom came; and those who were prepared entered in with him to the wedding.}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{32nd Sunday in OT} \label{32nd Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.32}
