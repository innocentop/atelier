...
\chapter{The Assumption\\of the Blessed Virgin Mary}
\section{Second Vespers}

\subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Hodie Maria Virgo} \label{Hodie Maria Virgo (Antiphona ad Magnificat)} \grecommentary[0pt]{} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--hodie_maria--dominican} \vspace{5pt} \textit{Today the Virgin Mary ascends to heaven; rejoice, for she reigns with Christ for ever.}
\subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}} \index[Canticum Evangelicum]{Magnificat 8G} \label{Magnificat 8G (Canticum Evangelicum)} \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/magnificat8G}
