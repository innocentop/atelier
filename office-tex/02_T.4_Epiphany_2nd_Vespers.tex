...
\section{Second Vespers}             \cleardoublepage 
 ...
 \subsubsection{Hymnus}  \greannotation{III} \index[Hymnus]{Hostis Herodes impie} \label{Hostis Herodes impie (Hymnus)} \grecommentary[0pt]{} \gresetinitiallines{1} \gresetlyriccentering{syllable}  \gregorioscore{chants/hy--hostis_herodes--english}    
 ...
 \subsubsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Benedicentur in ipso} \label{Benedicentur in ipso (Responsorium brevis)} \grecommentary[0pt]{Ps 71:17 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/rb--benedicentur_in_ipso--solesmes}   \newpage 
