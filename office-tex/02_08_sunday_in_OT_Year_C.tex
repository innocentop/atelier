...
\section{Second Vespers}
 ...
 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VII a} \index[Canticum Evangelicum]{} \label{ (Canticum Evangelicum)} \grecommentary[2pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat8G-c3} \input{chants/magnificat-translation}
