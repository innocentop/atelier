...
\pagestyle{empty}
 ...
 \subsection{Antiphona}  \greannotation{VIII} \index[Antiphona]{Vidi aquam} \label{Vidi aquam (Antiphona)} \grecommentary[0pt]{Ezech 47:1, 9} \gresetinitiallines{1} \grechangedim{spaceabovelines}{0.4 cm}{scalable} \gregorioscore{graduale-chants/an--vidi_aquam--dominican--id_7348} \grechangedim{spaceabovelines}{0 cm}{scalable} \vspace{5pt} \par{I saw water flowing from the right side of the temple, alleluia! and all to whom that water came were saved, and they shall say: Alleluia, alleluia! \par \textit{In die Paschæ:} \Vbar. This is the day the Lord has made; let us exult and rejoice in it. \par \textit{In aliis Dominicis usque ad Pentecosten:} \Vbar. Praise the Lord for He is good, for His mercy endures forever. \par \textit{In die Pentecostes:} \Vbar. Send forth your spirit, and they shall be created; and you shall renew the face of the earth.} \newpage
