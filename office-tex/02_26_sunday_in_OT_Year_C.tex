...
\chapter{26\textsuperscript{th} Sunday in Ordinary Time (Year C)}              
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VII d} \index[Antiphona ad Magnificat]{Dives ille} \label{Dives ille (Antiphona ad Magnificat)} \grecommentary[0pt]{S. Gregorius} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--dives_ille--solesmes} \vspace{5pt} \emph{The rich man begged for a drop of water, who had denied a morsel of bread to Lazarus.}   
 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VII d} \index[Canticum Evangelicum]{Magnificat 7d} \label{Magnificat 7d (Canticum Evangelicum)} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat7d} \input{chants/magnificat-translation}   
