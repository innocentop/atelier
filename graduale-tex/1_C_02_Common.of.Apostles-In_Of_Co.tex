...
\section{Common of Apostles}
 ...
 \subsubsection{Officium}  \greannotation{II} \index[Officium]{Mihi autem} \label{Mihi autem (Officium)} \grecommentary[0pt]{Ps 138:17; \Vbar. 1} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/in--mihi_autem_nimis--dominican--id_4899}  \vspace{5pt} \par{To me your friends are made exceedingly honorable, O God; their principality is exceedingly strengthened. \textit{T.P.} Alleluia. \Vbar. Lord, you have proved me, and known me; You have known when I sit and when I stand.}

 \subsubsection{Offertorium}  \greannotation{III} \index[Offertorium]{Constitues eos} \label{Constitues eos (Offertorium)} \grecommentary[5pt]{Ps 44:17, 18} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/of--constitues_eos--dominican--id_5091}  \vspace{5pt} \par{You shall make them princes over all the earth; they shall remember your name from generation to generation.}

  \subsubsection{Communio}  \greannotation{I} \index[Communio]{Ego vos elegi} \label{Ego vos elegi (Communio)} \grecommentary[0pt]{Io 15:16} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/co--ego_vos_elegi--dominican--id_4728}  \vspace{5pt} \par{I have chosen you from the world, in order that you might go and bring forth fruit, and that your fruit should last. \textit{T.P.} Alleluia.} \newpage
