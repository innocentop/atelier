...
\chapter{4\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Surrexerunt omnes} \label{Surrexerunt omnes (Antiphona ad Magnificat)} \grecommentary[5pt]{Lc 4:29 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--surrexerunt_omnes--solesmes} \vspace{5pt} \emph{They all arose and drove the Lord out of the town, and led him to the brow of the hill on which that city had been built, to hurl him down headlong.}
 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}} \index[Canticum Evangelicum]{} \label{ (Canticum Evangelicum)} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat8G-c3} \input{chants/magnificat-translation}
