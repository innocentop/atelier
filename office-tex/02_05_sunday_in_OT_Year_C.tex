...
%%Combination
\chapter{5\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I \textsc{d}} \index[Antiphona ad Magnificat]{Praeceptor} \label{Praeceptor (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 5:5} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--praeceptor--dominican--id_7176} \vspace{5pt} \emph{Teacher, working throughout the whole night we have caught nothing; but at your word I will let down the net.}
