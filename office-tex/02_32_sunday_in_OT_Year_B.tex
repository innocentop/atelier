...
%%Combination
\chapter{32\textsuperscript{nd} Sunday in Ordinary Time (Year B)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{IV \textsc{e}} \index[Antiphona ad Magnificat]{Vidua illa pauper} \label{Vidua illa pauper (Antiphona ad Magnificat)} \grecommentary[0pt]{Mc 12:44 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--vidua_illa_pauper--solesmes-op} \vspace{5pt} \emph{This poor widow, from her poverty, has contributed all she had, her whole livelihood.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{IV \textsc{e}} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat4E} \input{chants/magnificat-translation}
