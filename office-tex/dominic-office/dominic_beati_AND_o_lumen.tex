...
\chapter{Our Holy Father Dominic}
\section{Second Vespers}

\subsubsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Beati qui audiunt} \label{Beati qui audiunt (Responsorium brevis)} \grecommentary[3pt]{} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.4cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/rb--beati_qui_audiunt}   \vspace{5pt} \textit{\Rbar. Blessed are those who hear the word of God and keep it. \Vbar. They will bear fruit in patience.} \newpage
\subsubsection{Antiphona ad Magnificat}  \greannotation{VI} \index[Antiphona ad Magnificat]{O Lumen} \label{O Lumen (Antiphona ad Magnificat)} \grecommentary[3pt]{} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--o_lumen--vesperale}   \vspace{5pt} \textit{Light of the church, teacher of truth, rose of patience, ivory of chastity, you freely poured forth the waters of wisdom; preacher of grace, unite us with the blessed.}
\subsubsection{Canticum Evangelicum}  \greannotation{VI} \index[Canticum Evangelicum]{Magnificat 6} \label{Magnificat 6 (Canticum Evangelicum)} \grecommentary[7pt]{Lc 1:46-55} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.4cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/magnificat6}    \newpage
