...
\chapter[The Nativity of the Lord]{Graduale O.P.}
...
\subsection{Officium}  \greannotation{II} \index[Officium]{Dominus dixit} \label{Dominus dixit (Officium)} \grecommentary[0pt]{Ps 2:7; \Vbar. 1, 2, 8} \gresetinitiallines{1}  \gregorioscore{graduale-chants/in--dominus_dixit--dominican--id_6135}  \vspace{5pt} \par{} \newpage
\subsection{Responsorium}  \greannotation{II} \index[Responsorium]{Tecum principium} \label{Tecum principium (Responsorium)} \grecommentary[0pt]{Ps 109:3; \Vbar. 1} \gresetinitiallines{1}  \gregorioscore{graduale-chants/gr--tecum_principium--dominican--id_6602}  \vspace{5pt} \par{} \newpage
\subsection{Alleluia}  \greannotation{VIII} \index[Alleluia]{Dominus dixit} \label{Dominus dixit (Alleluia)} \grecommentary[0pt]{Ps 2:7} \gresetinitiallines{1}  \gregorioscore{graduale-chants/al--dominus_dixit--dominican--id_6629}  \vspace{5pt} \par{} \newpage
\subsection{Offertorium}  \greannotation{IV} \index[Offertorium]{Lætentur cæli} \label{Lætentur cæli (Offertorium)} \grecommentary[0pt]{Ps 95:11} \gresetinitiallines{1}  \gregorioscore{graduale-chants/of--laetentur_caeli--dominican--id_7062}  \vspace{5pt} \par{} \newpage
\subsection{Communio}  \greannotation{VI} \index[Communio]{In splendoribus} \label{In splendoribus (Communio)} \grecommentary[0pt]{Ps 109:3} \gresetinitiallines{1}  \gregorioscore{graduale-chants/co--in_splendoribus--dominican--id_7236}  \vspace{5pt} \par{} \newpage
