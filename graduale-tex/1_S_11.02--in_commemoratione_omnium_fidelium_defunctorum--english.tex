...
%%Combination
 ...
 \subsubsection{Officium}  \greannotation{VI} \index[Officium]{Requiem} \label{Requiem (Officium)} \grecommentary[5pt]{\textit{Requiem}: IV Esdr 2:34, 35; \Vbar. Ps 64:2} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/in--requiem--dominican--id_6527--en.gabc}


\newpage


\subsubsection{Offertorium}  \greannotation{II} \index[Offertorium]{Domine Iesu Christe} \label{Domine Iesu Christe (Offertorium)} \grecommentary[0pt]{\textit{Domine Iesu Christe}} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/of--domine_iesu_christe--dominican--id_6575--en}

\newpage

 \subsubsection{Communio}  \greannotation{VIII} \index[Communio]{Lux æterna} \label{Lux æterna (Communio)} \grecommentary[5pt]{\textit{Lux æterna}: IV Esdr 2:35} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/co--lux_aeterna--dominican--id_6519--en.gabc}
