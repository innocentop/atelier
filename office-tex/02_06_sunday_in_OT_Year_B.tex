...
\chapter{6\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I a} \index[Antiphona ad Magnificat]{Domine si vis [AR: Domine si tu vis]} \label{Domine si vis [AR: Domine si tu vis] (Antiphona ad Magnificat)} \grecommentary[3pt]{Mt 8:2-3} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--domine_si_vis--dominican--id_5446} \vspace{5pt} \emph{Lord, if you will, you can make me clean. And Jesus said to him: ``I do will it, be made clean."}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I a} \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1a-f3} \input{chants/magnificat-translation}
