...
\begin{center}\begin{huge}\textsc{Constitues eos}\end{huge}\end{center}
\begin{center}1950 Graduale (Suarez), page(s) 2*\end{center}
...
\gresetsecondannotation{\small \textsc{\textbf{VI et V.}}}
...
\includescore{re_constitues_eos.tex}
