...
\pagestyle{empty}
 ...
 \subsubsection{Invitatio in ostendenda sancta Cruce}  \greannotation{VI} \index[Invitatio in ostendenda sancta Cruce]{Invitatio in ostendenda sancta Cruce} \label{Invitatio in ostendenda sancta Cruce (Invitatio in ostendenda sancta Cruce)} \grecommentary[0pt]{Ecclesia} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/an--ecce_lignum--roman_missal--english}  \vspace{5pt} \par{} \newpage
  ...
  \subsubsection{Antiphon}  \greannotation{II} \index[Antiphona]{You alone surpass (Meinrad 2)} \label{You alone surpass (Meinrad 2) (Antiphona)} \grecommentary[0pt]{Ecclesia} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{syllable}  \gregorioscore{graduale-chants/misc--you-alone-surpass-all-other-cedars-meinrad2}  \vspace{5pt}

\subsubsection{Prayer}
Look, we pray, O Lord, on this your family \par
for whom our Lord Jesus Christ \par
did not hesitate to be delivered into the hands of the wicked, \par
and to undergo the torment of the Cross. \par
Who lives and reigns for ever and ever. \par
\Rbar. Amen.
