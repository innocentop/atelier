...
\chapter{11\textsuperscript{th} Sunday in Ordinary Time (Year C)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Sic et vos} \label{Sic et vos (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 17:10 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--sic_et_vos--solesmes} \vspace{5pt} \emph{Thus you too, when you have done everything that has been commanded, ought to say: We are useless servants, for what we had to do, we have done.}
