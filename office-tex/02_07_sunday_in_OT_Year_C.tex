...
\chapter{7\textsuperscript{th} Sunday in Ordinary Time (Year C)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Nolite iudicare} \label{Nolite iudicare (Antiphona ad Magnificat)} \grecommentary[8pt]{Mt 7:1-2} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--nolite_iudicare--dominican} \vspace{5pt} \emph{Do not judge, and you will not be judged; for in the judgment with which you judge, you shall be judged, says the Lord.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}} \index[Canticum Evangelicum]{Magnificat 8G}  \grecommentary[3pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat8G} \input{chants/magnificat-translation}
