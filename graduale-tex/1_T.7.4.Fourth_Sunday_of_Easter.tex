...
\newpage
 ...
 \subsection{Alleluia} Pro dominica tantum: \greannotation{I} \index[Alleluia]{Ego sum pastor} \label{Ego sum pastor (Alleluia)} \grecommentary[0pt]{Io 10:14} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \gregorioscore{graduale-chants/al--ego_sum_pastor--dominican--id_7120} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \vspace{5pt} \par{I am the good shepherd, and I know My sheep, and Mine know Me.} \newpage
