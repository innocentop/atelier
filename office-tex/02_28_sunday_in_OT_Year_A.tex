...
%%Combination
\chapter{28\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{III a} \index[Antiphona ad Magnificat]{Intravit autem rex} \label{Intravit autem rex (Antiphona ad Magnificat)} \grecommentary[5pt]{Mt 22:11, 12 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--intravit_autem_rex--solesmes_2009-op} \vspace{5pt} \emph{The king came in to meet the guests and saw a man there not dressed in a wedding garment and said to him, ``My friend, how is it that you came in here without a wedding garment?”}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}   \index[Oratio conclusiva]{28th Sunday in OT} \label{28th Sunday in OT (Oratio conclusiva)}     \input{prayers/or-ordinary-time.28}
