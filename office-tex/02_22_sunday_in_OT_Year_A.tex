...
\chapter{22\textsuperscript{nd} Sunday in Ordinary Time (Year A)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VI} \index[Antiphona ad Magnificat]{Qui enim voluerit} \label{Qui enim voluerit (Antiphona ad Magnificat)} \grecommentary[5pt]{Mt 16:25 [AR]} \grechangestyle{initial}{\fontsize{1}{1}\selectfont} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--qui_enim_voluerit--solesmes-op} \vspace{5pt} \emph{For he who wishes to save his life will lose it, and he who loses his life for my sake will find it, alleluia.}   

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VI} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat6} \input{chants/magnificat-translation}
