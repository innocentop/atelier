...
%%Combination
\chapter{21\textsuperscript{st} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VI \textsc{f}} \index[Antiphona ad Magnificat]{Dixit Simon Petrus} \label{Dixit Simon Petrus (Antiphona ad Magnificat)} \grecommentary[0pt]{Io 6:69 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--dixit_simon_petrus--solesmes-op} \vspace{5pt} \emph{Simon Peter said: ``Lord, to whom shall we go? You have the words of eternal life, alleluia, alleluia."}

   \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VI \textsc{f}}  \grecommentary[3pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel} \gregorioscore{chants/magnificat6} \input{chants/magnificat-translation}
