...
%%Combination
 ...
 \subsection{Offertorium}  \greannotation{II} \index[Offertorium]{Meditabor in mandatis} \label{Meditabor in mandatis (Offertorium)} \grecommentary[5pt]{Ps 118:47, 48} \gresetinitiallines{1}  \gregorioscore{graduale-chants/of--meditabor--dominican--id_6142}  

 \subsection{Offertorium}  \greannotation{II} \index[Offertorium]{Meditabor in mandatis} \label{Meditabor in mandatis (Offertorium)} \grecommentary[5pt]{Ps 118:47, 48} \gresetinitiallines{1}  \gregorioscore{graduale-chants/of--meditabor--dominican--id_6142-ficta}  \vspace{5pt}
