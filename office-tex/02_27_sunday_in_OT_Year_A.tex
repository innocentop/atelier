...
\chapter{27\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VI} \index[Antiphona ad Magnificat]{Malos male perdet} \label{Malos male perdet (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 21:41} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--malos_male_perdet--dominican--id_4954} \vspace{5pt} \emph{He will bring those evil men to an evil end; and will let out his vineyard to other tenants, who will give him the produce at the proper times.}   
 
 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VI} \index[Canticum Evangelicum]{Magnificat 6} \label{Magnificat 6 (Canticum Evangelicum)} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat6} \input{chants/magnificat-translation}
