...
%%Combination
\chapter{30\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Magister quod est} \label{Magister quod est (Antiphona ad Magnificat)} \grecommentary[4pt]{Mt 22:26, 37} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--magister_quod_est--dominican--id_5151} \vspace{5pt} \emph{``Master, which commandment of the Law is greatest?” Jesus said to them: ``Love the Lord your God with your whole heart,” alleluia.}   
