...
%%Combination
\chapter{25\textsuperscript{th} Sunday in Ordinary Time (Year B)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Qui maior est vestrum} \label{Qui maior est vestrum (Antiphona ad Magnificat)} \grecommentary[3pt]{Mt 23:11, 12} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--qui_maior--dominican--id_5521} \vspace{5pt} \emph{He who is the greatest among you shall be your servant: for everyone who exalts himself will be humbled, says the Lord.}
