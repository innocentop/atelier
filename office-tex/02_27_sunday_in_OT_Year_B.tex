...
\chapter{27\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VII a} \index[Antiphona ad Magnificat]{Sinite parvulos} \label{Sinite parvulos (Antiphona ad Magnificat)} \grecommentary[2pt]{Mt 19:14 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--sinite_parvulos--solesmes-op} \vspace{5pt} \emph{Let the children come to me: for the Kingdom of Heaven belongs to such as these.}
