...
\chapter{14\textsuperscript{th} Sunday in Ordinary Time (Year B)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Amen dico vobis quia nemo} \label{Amen dico vobis quia nemo (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 4:24} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--amen_dico_vobis_quia_nemo--dominican} \vspace{5pt} \emph{Amen, I say to you, no prophet is accepted in his homeland.}
