...
\pagestyle{empty}
 ...
 \subsection{Alleluia}  \greannotation{VIII} \index[Alleluia]{Confitemini Domino} \label{Confitemini Domino (Alleluia)} \grecommentary[0pt]{} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \gregorioscore{graduale-chants/al--confitemini_quoniam_sab_sancto--dominican--id_5407--alleluia--only} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \vspace{5pt} \par{} \newpage
