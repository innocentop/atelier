...
%%Combination
\section{The Triumph of the Cross}

 \subsubsection{Offertorium}  \greannotation{II} \index[Offertorium]{Protege} \label{Protege (Offertorium)} \grecommentary[0pt]{} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}  \gregorioscore{graduale-chants/of--protege_domine--dominican--id_4811}  \vspace{5pt} \par{Protect your people, O Lord, by the sign of the holy cross, from the attacks of all enemies, that we may present to you a pleasing service, and our sacrifice may be acceptable to you.} \newpage
