...
\grechangedim{maxbaroffsettextleft}{0 cm}{scalable}
 ...
 \subsection{Antiphona III}  \greannotation{IV} \index[Antiphona III]{Si ego Dominus} \label{Si ego Dominus (Antiphona III)} \grecommentary[5pt]{Cf. Io 13:14; \Vbar. 15} \gresetinitiallines{1} \grechangedim{maxbaroffsettextleft@nobar}{0 cm}{scalable} \gregorioscore{graduale-chants/an--si_ego_dominus--dominican} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \vspace{5pt} \par{If I, your Lord and Teacher, have washed your feet, then surely, all the more, ought you to wash one another's feet. \Vbar. I have given you an example, that you may do likewise.} \newpage
