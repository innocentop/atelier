...
\chapter{14\textsuperscript{th} Sunday in Ordinary Time (Year C)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Gaudete et exsultate} \label{Gaudete et exsultate (Antiphona ad Magnificat)} \grecommentary[0pt]{Lc 10:20 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--gaudete_et_exsultate--solesmes--op} \vspace{5pt} \emph{Rejoice and be glad, for your names are written in heaven, says the Lord.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}} \grecommentary[4pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat8G} \input{chants/magnificat-translation}
