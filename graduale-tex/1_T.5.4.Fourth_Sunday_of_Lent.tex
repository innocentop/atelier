...
%%Combination
 ...
 \subsection{Offertorium} Annis A et B: \greannotation{II} \index[Offertorium]{Laudate Dominum} \label{Laudate Dominum (Offertorium)} \grecommentary[0pt]{Ps 134:3, 6} \gresetinitiallines{1}  \gregorioscore{graduale-chants/of--laudate_dominum--dominican--id_5285}  \vspace{5pt} \par{Praise the Lord, for He is good; sing to His name, for He is sweet; whatsoever He pleased He has done in heaven and in earth.} \newpage

 \subsection{Offertorium} Anno C (Quando legitur Evangelium de filio prodigo): \greannotation{IV} \index[Offertorium]{Illumina oculos meos} \label{Illumina oculos meos (Offertorium)} \grecommentary[5pt]{Ps 12:4, 5} \gresetinitiallines{1}  \gregorioscore{graduale-chants/of--illumina--dominican--id_5998}  \vspace{5pt} \par{Enlighten my eyes lest I fall into the sleep of death; lest my enemy say: ``I have prevailed against him."} \newpage
 ...
 \subsection{Communio} Anno C (Quando legitur Evangelium de filio prodigo): \greannotation{VIII} \index[Communio]{Oportet te} \label{Oportet te (Communio)} \grecommentary[0pt]{Lc 15:32} \gresetinitiallines{1}  \gregorioscore{graduale-chants/co--oportet_te_fili--dominican--id_6842}  \vspace{5pt} \par{You ought to rejoice, my son, because Your brother was dead, and has come to life; he was lost, and is found.} \newpage
