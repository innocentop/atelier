...
\chapter[3\textsuperscript{rd} Sunday in Ordinary Time (Years A and B)]{3\textsuperscript{rd} Sunday in Ordinary Time \\ (Years A and B)}
\section{Second Vespers}  \vspace{-10pt}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Ambulans Iesus} \label{Ambulans Iesus (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 4:18, 19, 20} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--ambulans_iesus--dominican--id_5782} \vspace{5pt} \emph{While Jesus was walking next to the see of Galilee, he saw Peter, and Andrew his brother, and said to them: ``Come after me, I will make you fishers of men." At that, they left the nets and ship and followed him.}
 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord}\greannotation{I g} \label{Magnificat 8G (Canticum Evangelicum)} \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1g} \input{chants/magnificat-translation}
...
\newpage
 \subsubsection{Oratio conclusiva} \input{prayers/or-ordinary-time.03}
