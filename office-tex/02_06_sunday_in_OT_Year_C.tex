...
\chapter{6\textsuperscript{th} Sunday in Ordinary Time (Year C)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I \textsc{d}} \index[Antiphona ad Magnificat]{Beati eritis} \label{Beati eritis (Antiphona ad Magnificat)} \grecommentary[5pt]{Lc 6:22-23} \gresetinitiallines{1} \gresetlyriccentering{vowel}
\grechangedim{spaceabovelines}{0.4 cm}{scalable}
  \gregorioscore{chants/an--beati_eritis--dominican--id_6750} \vspace{5pt} \emph{Blessed will you be, when men will hate you, and when they will divide you, and will upbraid you, and will throw out your name as something evil, on account of the Son of Man. Rejoice and be glad: for your reward is great in heaven.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{I \textsc{d}} \grecommentary[5pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat1d-f3} \input{chants/magnificat-translation}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}       \input{prayers/or-ordinary-time.06}
