...
\chapter{4\textsuperscript{th} Sunday in Ordinary Time (Year A)}
\section{Second Vespers}
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{I g} \index[Antiphona ad Magnificat]{Beati pacifici} \label{Beati pacifici (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 5:9, 8} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--beati_pacifici--dominican--id_5147} \vspace{5pt} \emph{Blessed are the peacemakers, blessed are the pure of heart: for they will see God.}
