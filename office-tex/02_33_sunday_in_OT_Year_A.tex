...
%%Combination
\chapter{33\textsuperscript{rd} Sunday in Ordinary Time (Year A)}
...
\section{Second Vespers}
 ...
 \subsubsection{Responsorium brevis}  \greannotation{VI} \index[Responsorium brevis]{Benedictus es, Domine} \label{Benedictus es, Domine (Responsorium brevis)} \grecommentary[0pt]{Dan 3:56 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/rb--benedictus_es_domine--solesmes}
  ...
  \subsubsection{Antiphona ad Magnificat}  \greannotation{IV \textsc{e}} \index[Antiphona ad Magnificat]{Serve bone et fidelis} \label{Serve bone et fidelis (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 25:21 [AR]} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--serve_bone_et_fidelis--solesmes-op} \vspace{5pt} \emph{Good and faithful servent, because you have been faithful in small matters, I will put you in charge of great ones; enter into the joy of the Lord your God.}
 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VII a}  \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat4E} \input{chants/magnificat-translation}
