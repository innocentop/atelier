...
\chapter{2\textsuperscript{nd} Sunday in Ordinary Time (Year B)}
...
%%This is the version for Week II and IV
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VIII \textsc{g}} \index[Antiphona ad Magnificat]{Dixit Andreas} \label{Dixit Andreas (Antiphona ad Magnificat)} \grecommentary[3pt]{Io 1:41 [AR]} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/an--dixit_andreas--solesmes} \vspace{5pt} \emph{Andrew said to Simon his brother: We have found the Messiah, which means the Christ.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VIII \textsc{g}} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat8G-c3} \newpage \input{chants/magnificat-translation}
