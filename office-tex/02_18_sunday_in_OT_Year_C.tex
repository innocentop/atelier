...
\chapter{18\textsuperscript{th} Sunday in Ordinary Time (Year C)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{VII d} \index[Antiphona ad Magnificat]{Si vere fratres} \label{Si vere fratres (Antiphona ad Magnificat)} \grecommentary[0pt]{S. Gregorius} \gresetinitiallines{1} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--si_vere_fratres--dominican} \vspace{5pt} \emph{If you truly wish to be rich, brothers, love true riches.}

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{VII d} \grecommentary[4pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat7d} \input{chants/magnificat-translation}
