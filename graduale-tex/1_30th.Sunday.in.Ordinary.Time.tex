...
%%Combination
 \subsection{Officium}  \greannotation{II} \index[Officium]{Lætetur cor} \label{Lætetur cor (Officium)} \grecommentary[0pt]{Ps 104:3, 4; \Vbar. 1} \gresetinitiallines{1}  \gregorioscore{graduale-chants/in--laetetur_cor--dominican--id_6129}  \vspace{5pt} \par{} \newpage
 \subsection{Responsorium} Dom. annis A et B: \greannotation{V} \index[Responsorium]{Unam petii} \label{Unam petii (Responsorium)} \grecommentary[0pt]{Ps 26:4} \gresetinitiallines{1}  \gregorioscore{graduale-chants/gr--unam_petii_v_ut_videam--dominican--id_4740}  \vspace{5pt} \par{} \newpage
 \subsection{Responsorium} Dom. anno C: \greannotation{VII} \index[Responsorium]{Clamaverunt iusti} \label{Clamaverunt iusti (Responsorium)} \grecommentary[0pt]{Ps 33:18; \Vbar. 19 [GR]} \gresetinitiallines{1}  \gregorioscore{graduale-chants/gr--clamaverunt--vatican}  \vspace{5pt} \par{} \newpage
 \subsection{Alleluia}  \greannotation{IV} \index[Alleluia]{Lauda Ierusalem} \label{Lauda Ierusalem (Alleluia)} \grecommentary[0pt]{Ps 147:1 [GR]} \gresetinitiallines{1}  \gregorioscore{graduale-chants/al--lauda_ierusalem--vatican}  \vspace{5pt} \par{} \newpage
 \subsection{Offertorium}  \greannotation{III} \index[Offertorium]{Domine, vivifica me} \label{Domine, vivifica me (Offertorium)} \grecommentary[0pt]{Ps 118:107, 125} \gresetinitiallines{1}  \gregorioscore{graduale-chants/of--domine_vivifica--dominican--id_4306}  \vspace{5pt} \par{} \newpage
 \subsection{Communio}  \greannotation{II} \index[Communio]{Lætabimur} \label{Lætabimur (Communio)} \grecommentary[0pt]{Ps 19:6} \gresetinitiallines{1}  \gregorioscore{graduale-chants/co--laetabimur--dominican--id_6160}  \vspace{5pt} \par{} \newpage
