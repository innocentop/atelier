...
\chapter{14\textsuperscript{th} Sunday in Ordinary Time (Year A)}
...
\newpage
 ...
 \subsubsection{Antiphona ad Magnificat}  \greannotation{II} \index[Antiphona ad Magnificat]{Tolite iugum} \label{Tolite iugum (Antiphona ad Magnificat)} \grecommentary[0pt]{Mt 11:29, 30 [AR]} \grechangestyle{initial}{\fontsize{1}{1}\selectfont} \grechangestyle{initial}{\fontsize{36}{36}\selectfont} \grechangedim{maxbaroffsettextleft@nobar}{12 cm}{scalable} \grechangedim{spaceabovelines}{0.5cm}{scalable} \gresetlyriccentering{vowel}   \gregorioscore{chants/an--tollite_iugum_meum--solesmes-op} \vspace{5pt} \emph{Take my yoke upon you, says the Lord, and learn from me, for I am meek and humble of heart; for my yoke is sweet and my burden light.}   

 \subsubsection{Canticum Evangelicum} \paragraph{The soul rejoices in the Lord} \greannotation{II} \grecommentary[0pt]{Lc 1:46-55} \gresetinitiallines{1} \gresetlyriccentering{vowel}  \gregorioscore{chants/magnificat2} \input{chants/magnificat-translation}
...
\newpage
 ...
 \subsubsection{Oratio conclusiva}       \input{prayers/or-ordinary-time.14}
